...
$input->SetNotify_url("/Index.php?s=Index/weixinpay/notify");//回调url
...
<body>
	...
	<img alt="模式二扫码支付" src="qrcode.php?data=<?php echo urlencode($url1);?>" style="width:150px;height:150px;"/>
